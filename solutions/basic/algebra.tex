\section{Algebra}
\paragraph*{Problem~\ref{p:b:a:systems:1}}
...
\end{proof}
\paragraph*{Problem~\ref{p:b:a:systems:2}}
...
\end{proof}
\paragraph*{Result~\ref{r:b:a:quad:1}}
...
\end{proof}
\paragraph*{Result~\ref{r:b:a:quad:2}}
...
\end{proof}
\paragraph*{Problem~\ref{p:b:a:quad:1}}
...
\end{proof}
\paragraph*{Problem~\ref{p:b:a:quad:2}}
...
\end{proof}
\paragraph*{Problem~\ref{p:b:a:quad:3}}
...
\paragraph*{Result~\ref{r:b:a:ineq:1}}
...
\paragraph*{Problem~\ref{p:b:a:ineq:1}}
...
\end{proof}
\paragraph*{Result~\ref{r:b:a:sums:1}}
...
\begin{proof}
  ...
  as needed.
\end{proof}
\paragraph*{Result~\ref{r:b:a:sums:2}}
...
\end{proof}
\paragraph*{Problem~\ref{p:b:a:sums:1}}
