...
\begin{result}[Isosceles triangle]{\label{r:b:g:c:1}}
...
r^2$.
\begin{result}[Thales' Theorem]{\label{r:b:g:ci:1}}
...
\end{result}
\begin{result}[Bowtie Theorem]{\label{r:b:g:ci:4}}
...
\subsection{Similarity}
  ...
  known as RHS\@.
  \begin{result}[Similar Switch]{\label{r:b:g:s:1}}
...
\end{problem}
\begin{result}[Angle Bisector Theorem]{\label{r:b:g:a:4}}
...
\begin{result}[Pythagoras' Theorem]{\label{r:b:g:py:1}}
...
\begin{result}[Extended Rule of Sines]{\label{r:b:g:t:4}}
  ...
  all equal to $2R$.
\end{result}
\begin{result}[Rule of Cosines]{\label{r:b:g:t:5}}
